    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Company>(entity =>
        {
            ...
            entity.HasData(new Company[]
            {
                new Company()
                {
                    CompanyID = 1, CompanyName = "The HR Agency", Address = "12345-145 street, Edmonton, Ab, T5X6V8",
                    Phone = "7809848855", CPFirstName = "Carol", CPLastName = "Clinton",
                    CPEmail = "bClinton@arkansas.com", StartDate = DateOnly.Parse("2022-10-01"),
                    EndDate = DateOnly.Parse("2023-10-01"), SubscriptionStatus = true
                },

                new Company()
                {
                    CompanyID = 2, CompanyName = "Zellers, Inc.", Address = "14545-173 street, Edmonton, Ab, T5X6V8",
                    Phone = "8255872233", CPFirstName = "John", CPLastName = "Doe", CPEmail = "jdoe@anonymous.com",
                    StartDate = DateOnly.Parse("2021-09-01"), EndDate = DateOnly.Parse("2023-09-01"),
                    SubscriptionStatus = true
                },

                new Company()
                {
                    CompanyID = 3, CompanyName = "General Motors, Inc.", Address = "145 Fir Street, Detroit, Mi, 90251",
                    Phone = "7809841155", CPFirstName = "Frank", CPLastName = "Smith", CPEmail = "fsmith@gm.com",
                    StartDate = DateOnly.Parse("2022-10-01"), EndDate = DateOnly.Parse("2023-10-01"),
                    SubscriptionStatus = true
                },

                new Company()
                {
                    CompanyID = 4, CompanyName = "Ford, Inc.", Address = "800 Ford Street,Dearborn, MI, 95874",
                    Phone = "15558792225", CPFirstName = "Henry", CPLastName = "Ford", CPEmail = "hFord@ford.com",
                    StartDate = DateOnly.Parse("2019-02-01"), EndDate = DateOnly.Parse("2022-10-01"),
                    SubscriptionStatus = false
                },

                new Company()
                {
                    CompanyID = 5, CompanyName = "Frank's Food Emporium",
                    Address = "8524-99 street, Edmonton, Ab, T6X7Y3", Phone = "4032454875", CPFirstName = "Joe",
                    CPLastName = "Rogan", CPEmail = "frankF@ffe.com", StartDate = DateOnly.Parse("2021-10-01"),
                    EndDate = DateOnly.Parse("2022-10-01"), SubscriptionStatus = false
                }
            });
        ...
        modelBuilder.Entity<UserInfo>(entity =>
        {
            ...
            entity.HasIndex(e => e.CompanyFKID, "FK_UserInfo_Company");
            entity.Property(e => e.UserID).HasColumnType("int(11)").HasColumnName("UserID").ValueGeneratedOnAdd();
            entity.Property(e => e.CompanyFKID).HasColumnType("int(11)").HasColumnName("CompanyID");
            entity.Property(e => e.PermissionLevel).HasColumnType("int(1)").HasColumnName("PermissionLevel");
//            entity.HasOne(userinfo => userinfo.Company).WithOne(Company => Company.UserInfo)
//                .HasForeignKey(UserInfo => UserInfo.CompanyID).OnDelete(DeleteBehavior.Restrict)
//                .HasConstraintName("FK_UserInfo_Company");
            entity.HasOne(a => a.Company).WithOne(b => b.UserInfo).HasForeignKey<Company>(o => o.CompanyID);
            entity.HasData(new UserInfo[]
            {
                new UserInfo() { UserID = 1, CompanyFKID = 1, PermissionLevel = 1 },
                new UserInfo() { UserID = 2, CompanyFKID = 2, PermissionLevel = 2 },
                new UserInfo() { UserID = 3, CompanyFKID = 3, PermissionLevel = 2 },
                new UserInfo() { UserID = 4, CompanyFKID = 4, PermissionLevel = 2 },
                new UserInfo() { UserID = 5, CompanyFKID = 5, PermissionLevel = 2 },
            });
        ...
        modelBuilder.Entity<Package>(entity =>
        {
            ...
            entity.Property(e => e.PackageName).HasColumnType("varchar(30)").HasColumnName("PackageName")
                .HasMaxLength(30);
            entity.HasOne(Package => Package.Company).WithMany(Company => Company.Packages)
