  ...
  protected override void OnModelCreating(ModelBuilder modelBuilder)
  {
    ...
    modelBuilder.Entity<Company>(entity =>
    {
      ...
      entity.HasData(new Company[]
          {
                new Company(){CompanyID = 1, CompanyName= "The HR Agency", Address = "12345-145 street, Edmonton, Ab, T5X6V8", Phone="7802225555", CPFirstName ="Carolina", CPLastName="Gonzales", CPEmail= "carolina.gonzales@telus.net", StartDate=DateOnly.Parse("2022-10-01"), EndDate=DateOnly.Parse("2023-10-01"), SubscriptionStatus = true},
