...
export const EditClientForm = () => {
    ...
    useEffect(() => {
        ...
        const populateRoles = async () => {
            ...
            if (responseList.ok) {
                ...
                //console.log("response list.text: " + await responseList.text());
                console.log("Line 29, dataList.text: " + await dataList);

                formInputValue = {  //
                     CompanyName: dataList.companyName, Address: dataList.address, Phone: dataList.phone, CPFirstName: dataList.cpFirstName, CPLastName: dataList.cpLastName, CPEMail: dataList.cpEMail, StartDate: dataList.startDate, EndDate: dataList.endDate //, SubscriptionStatus: dataList.subscriptionStatus, PackageType: dataList.PackageName, PermissionLevel: dataList.PermissionLevel
                };      
                console.log("Line 35 formInputValue: " + formInputValue);
    ...
    const submitHandler = async (e) => {
        e.preventDefault();
        console.log("line 46: "+inputValue);
        ...
        if ((inputValue.CompanyName).trim() === "") {
            ...
            try {
                let urlParams =
                {
                    editCompanyID:inputValue.companyID,
                    ...
                    editPackageName: inputValue.PackageName,
